...
using AfarsoftResourcePlan.Web.Models.Account;
using AfarsoftResourcePlan.Web.Views.Shared.Components.TenantChange;

namespace AfarsoftResourcePlan.Web.Controllers
{
    public class AccountController : AfarsoftResourcePlanControllerBase
    {
