...
using Abp.UI;
using AfarsoftResourcePlan.Authentication.External;
...
using AfarsoftResourcePlan.Models.TokenAuth;
using AfarsoftResourcePlan.MultiTenancy;

namespace AfarsoftResourcePlan.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : AfarsoftResourcePlanControllerBase
    {
